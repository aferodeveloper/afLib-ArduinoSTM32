...
#ifndef AF_STM32_UART_TRANSPORT_H
#define AF_STM32_UART_TRANSPORT_H

#include "af_transport.h"

// You shouldn't call this directly but instead use the stm32_transport_create_uart call
...
#endif /* AF_STM32_UART_TRANSPORT_H */

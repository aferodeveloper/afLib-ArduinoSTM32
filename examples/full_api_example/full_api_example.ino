...
// Blue Pill pins - we use Serial2 for UART in this app.
#define RESET                     PA1   // This is used to reboot the Modulo when the MCU boots.
...
void setup() {
  ...
  stm32_logger_start(&Serial1, 115200);
  ...
  // different stm32_transport_create() calls; once the af_lib object is created, your app
